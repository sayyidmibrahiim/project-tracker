...
Read `AGENTS.md` first, then read project state in this order before coding:
...
Workflow/tooling change → AGENTS.md. Important change (decision, architecture, convention, state) → update claude-mem (mandatory, not optional).
