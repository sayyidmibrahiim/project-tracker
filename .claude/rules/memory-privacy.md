...
- Do not store secrets, credentials, tokens, API keys, passwords, private keys, or PII in claude-mem, context-mode, graphify, session notes, or Claude auto-memory.
