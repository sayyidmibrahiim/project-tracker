...
- claude-mem is MANDATORY every session (all providers): recall at session start to save tokens, update on every important change. Store decisions and conventions, not transcript dumps.
