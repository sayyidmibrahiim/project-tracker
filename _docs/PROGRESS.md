...
Active branch: `general/window-titlebar-selection` (from `main`). Tiny post-merge titlebar selection-leak fix passed user live verification on 2026-07-11 and is approved for merge. Native frameless-window + responsive fixes merged to `main` on 2026-07-11 (`bf2014e1`, merge `18859d1b`; feature branch kept). Piece D CICD Workbench v2 merged 2026-07-09; Automation System epic (Slices 1–5) merged 2026-07-08.
